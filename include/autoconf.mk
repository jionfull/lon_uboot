...
CONFIG_ETHADDR="01:02:03:04:05:06"
...
CONFIG_SYS_AT91_MAIN_CLOCK=10000000
...
CONFIG_CMD_NAND=y
CONFIG_BOOTARGS="console=ttyS0,115200 root=/dev/mtdblock5 mtdparts=atmel_nand:128k(bootstrap)ro,256k(uboot)ro,128k(env1)ro,128k(env2)ro,2M(linux),-(root) rw rootfstype=jffs2"
CONFIG_CMD_MEMORY=y
...
CONFIG_BOOTCOMMAND="nand read 0x22000000 0xA0000 0x200000; bootm"
CONFIG_CMD_SETGETDCR=y
CONFIG_NET_RETRY_COUNT=20
CONFIG_AT91_LED=y
CONFIG_GREEN_LED="AT91_PIO_PORTA, 24"
CONFIG_ZLIB=y
